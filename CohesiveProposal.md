...
- If Rocket Pool is at "maturity" (market share ranging from 16% to 22%), the total rETH Commission Fee will be somewhere between it's manual input target (say 14%) and 100%. As an example, if Rocket Pool reached a market share of 20%, it would then charge rETH holders a 71.33% commission fee. That would l- If Rocket Pool reaches its hard limit market share of 22%, the total rETH Commission Fee will be 100% (meaning no ETH revenue goes to rETH holders, which removes incentives to hold rETH).rETH to balance back to its target market share at the soft limit.
